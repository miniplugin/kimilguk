...
#### 20210406(화) 작업예정
- 수업전:코딩테스트09문제확인.(카카오-균형잡힌 괄호만들기 코딩테스트문제)
- 코딩테스트10문제예정.(토스-송금앱의 코딩테스트문제)
- 4교시에 과제물 제출예정. 이후 15번째 과목 진행 시작.
...
- 노드js사용목적(React, Vue): SPA프로그램(Single Page App) 1페이지에 CRUD 가능한 간단한 앱을 만드는 것이 목적.(기술분포: 백엔드약간+프론트엔드많이 )
