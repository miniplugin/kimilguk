...
- 취업진행 아래 2가지 절차
- 중소기업/대기업 : 스프링프레임워크 로 바로작업하지 않고, 스프링프레임워크기반 회사프레임워크
- 회사 솔루션(상품-오픈소스X)
- 회사 프레임워크(위-오픈소스X=핵심기술 jar로 만들어서 소스를 숨겨놓습니다.)
- 스프링 프레임워크(위-오픈소스O)
- 회사유형1(중소기업): 이력서 + 포트폴리오 + 면접(인성,포트폴리오기술)
- 회사유형2(대기업): 이력서 + 온라인(오프라인)코딩테스트(1문제를 2개 언어로=Java,C) + 면접(인성,코딩테스트기술)
- -----------------------------------------------
